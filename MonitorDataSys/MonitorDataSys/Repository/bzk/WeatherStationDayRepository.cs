...
{
    public class WeatherStationDayRepository
    {
        ...
        /// </summary>
        public WeatherStationDayRepository(string bzkSQLServerDbServerIP, string bzkSQLServerDbServerPort, string bzkSQLServerDbServerUserId, string bzkSQLServerDbServerUserPassword, string bzkSQLServerProviderName, string bzkSQLServerDbName)
        {
