...
{
    public class CityMonitorHourRepository
    {
        ...
        /// </summary>
        public CityMonitorHourRepository(string bzkSQLServerDbServerIP, string bzkSQLServerDbServerPort, string bzkSQLServerDbServerUserId, string bzkSQLServerDbServerUserPassword, string bzkSQLServerProviderName, string bzkSQLServerDbName)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public bool IsCompeletCollect(string tableName, string cityCode, DateTime monitorTime)
        {
            bool result = false;
            try
            {
                ...
                sb.AppendFormat("select * from {0} where 1=1 and CITY_CODE ='{1}' and MONITOR_TIME = '{2}' ", tableName, cityCode, monitorTime.ToString("yyyy-MM-dd HH:mm:ss.fff"));
