...
namespace WeatherDataSys.UtilTool
{
    public class DBHelper
    {
        ...
        public DBHelper(string dbServerIP, string dbServerPort, string dbServerUserId, string dbServerUserPassword, string providerName, string dbName)
        {
            ConnectionStringSettings conectionStringSetting = GetConnection(dbServerIP, dbServerPort, dbServerUserId, dbServerUserPassword, providerName, dbName);
        ...
        public ConnectionStringSettings GetConnection(string dbServerIP, string dbServerPort, string dbServerUserId, string dbServerUserPassword, string providerName, string dbName)
        {
            ConnectionStringSettings con = new ConnectionStringSettings();
            con = GetPostgreSqlOracleConnection(dbServerIP, dbServerPort, dbServerUserId, dbServerUserPassword, providerName, dbName);
            return con;
        }
        ...
        /// <returns></returns>
        public ConnectionStringSettings GetPostgreSqlOracleConnection(string dbServerIP, string dbServerPort, string dbServerUserId, string dbServerUserPassword, string providerName, string dbName)
        {
            ConnectionStringSettings con = new ConnectionStringSettings();
            ...
            {
                case "PostgreSQL":
                    con.ConnectionString = String.Format("Server={0};Port={1};User Id={2};Password={3};Database={4};Pooling=true;Timeout = 300;CommandTimeout = 3600; ", dbServerIP, dbServerPort, dbServerUserId, dbServerUserPassword, dbName);
                    break;
                case "Oracle":
        ...
        /// <param name="dbName"></param>
        /// <returns></returns>
        public ConnectionStringSettings GetCustomSQLServerConnection(string dbServerIP, string dbServerPort, string dbServerUserId, string dbServerUserPassword, string providerName, string dbName)
        {
            ConnectionStringSettings con = new ConnectionStringSettings();
            con.ProviderName = providerName;
            string portFilter = "";
